...
public class ChuanCiGroupBottleAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
...
//  private Bitmap bitmapGirl =null;
  public ChuanCiGroupBottleAdapter(Context context, List<GroupBottleModel> items) {
  ...
  @Override public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild,
    ...
    holder.btnMore.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {    //暂时注释
            activity.chuanCiPeopleFragment.redirect2ExecuteSingleByClick(bottle);
        }
    });
