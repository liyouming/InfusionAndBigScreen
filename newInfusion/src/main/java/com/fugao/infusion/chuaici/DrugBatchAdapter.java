...
public class DrugBatchAdapter extends BaseAdapter {
    ...
    public DrugBatchAdapter(Context context, List<DrugDetailModel> drugs) {
    ...
    public DrugBatchAdapter(Context context, List<DrugDetailModel> drugs, String bid) {
        this.context = context;
        this.drugs = drugs;
        inflater = LayoutInflater.from(context);
...
//            holder.tui_sign = (ImageView) convertView.findViewById(R.id.tui_sign);
        ...
        if (drugs != null) {
            ...
            if (!TextUtils.isEmpty(this.originalBottleId) && this.originalBottleId.equals(
                    drug.BottleId)) {
