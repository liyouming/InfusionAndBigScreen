 ...
 * @Description: TODO 瓶贴表字段名字 必须继承BaseColumns
...
public abstract class BottleColumns implements BaseColumns {
  ...
  public static final String PillName = "PillName";//排药人
  ...
  public static final String LiquorName = "LiquorName";//配液人
  ...
  public static final String InfusionName = "InfusionName";//输液人
  ...
  public static final String EndName = "EndName";//结束人
  ...
  public static final String LZZ = "LZZ";//留置针
  public static final String GCF = "GCF";//观察费
  public static final String CheckCore="CheckCore";
