 ...
 * @date: 2014年1月2日 下午5:04:19
 */
public class ChoosePunctureAdapter extends BaseAdapter {
    private Activity mactivity;
    private List<InfusionAreaBean> beans;
     ...
     * @Description:TODO
     */
    public ChoosePunctureAdapter(Activity activity,
                                 List<InfusionAreaBean> infusionAreaBeans) {
...
//        if(getIsSelected().size()!=0)hodler.item_cb.setChecked(getIsSelected().get(position));
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        ChoosePunctureAdapter.isSelected = isSelected;
    }
