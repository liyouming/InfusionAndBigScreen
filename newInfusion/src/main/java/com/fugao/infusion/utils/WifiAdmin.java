...
public class WifiAdmin {
  ...
  public boolean connectNetwork(WifiConfiguration wcg) {
    boolean connectStaues;
    int wcgID = mWifiManager.addNetwork(wcg);
    connectStaues = mWifiManager.enableNetwork(wcgID, true);
    return connectStaues;
  }
