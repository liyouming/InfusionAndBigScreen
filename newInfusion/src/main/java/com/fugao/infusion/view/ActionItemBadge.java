...
public class ActionItemBadge {
  ...
  public static class Add {
    ...
    public Menu build(Iconify.IconValue icon, int badgeCount) {
      return build(
          new IconDrawable(activity, icon).colorRes(R.color.actionbar_text).actionBarSize(),
          BadgeStyle.GREY, badgeCount);
    }
    ...
    public Menu build(Iconify.IconValue icon, BadgeStyle style, int badgeCount) {
      return build(
          new IconDrawable(activity, icon).colorRes(R.color.actionbar_text).actionBarSize(), style,
          badgeCount);
    }
  ...
  public static void update(final Activity act, final MenuItem menu, BadgeStyle style,
      int badgeCount) {
    if (style.getStyle() != BadgeStyle.Style.LARGE) {
      throw new RuntimeException(
          "You are not allowed to call update without an icon on a Badge with default style");
    }
    update(act, menu, (Drawable) null, style, badgeCount);
  }

  public static void update(final Activity act, final MenuItem menu, Iconify.IconValue icon,
      int badgeCount) {
    update(act, menu, new IconDrawable(act, icon).colorRes(R.color.actionbar_text).actionBarSize(),
        BadgeStyle.GREY, badgeCount);
  }
  ...
  public static void update(final Activity act, FrameLayout menu, Iconify.IconValue icon,
      BadgeStyle style, int badgeCount) {
      View view = menu.getRootView();
      TextView textView = (TextView) view.findViewById(R.id.menu_badge_text);
      ...
      ActionItemBadge.setBackground(imageView, new IconDrawable(act, icon).colorRes(R.color.actionbar_text).actionBarSize());
  }

  public static void update(final Activity act, final FrameLayout menu, Drawable icon,
      BadgeStyle style, int badgeCount) {
    View badge = menu.getRootView();
