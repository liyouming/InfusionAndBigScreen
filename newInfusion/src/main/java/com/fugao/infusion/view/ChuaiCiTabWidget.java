...
public class ChuaiCiTabWidget extends LinearLayout {

	private static final String TAG = "TabWidget";
	private int[] mDrawableIds = new int[] { R.drawable.tab_signs_selector,
			R.drawable.tab_icon_people_list_selector,
	...
	public ChuaiCiTabWidget(Context context, AttributeSet attrs, int defStyle) {
...
//			}
	...
	public ChuaiCiTabWidget(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ChuaiCiTabWidget(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(final Context context) {
		...
		this.setBackgroundResource(R.drawable.tab_dibu_bg_drawable);
