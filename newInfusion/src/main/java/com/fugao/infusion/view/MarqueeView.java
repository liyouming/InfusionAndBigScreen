...
public class MarqueeView extends LinearLayout {
  ...
  private void extractAttributes(AttributeSet attrs) {
    ...
    mSpeed =
        a.getInteger(R.styleable.asia_ivity_android_marqueeview_MarqueeView_speed, DEFAULT_SPEED);
    mAnimationPause = a.getInteger(R.styleable.asia_ivity_android_marqueeview_MarqueeView_pause,
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if (changed) {
      ...
      if (!(v instanceof TextView)) {
        if (v instanceof ScrollView) return;
