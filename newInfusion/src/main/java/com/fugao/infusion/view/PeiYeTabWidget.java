...
public class PeiYeTabWidget extends LinearLayout {
	...
	public PeiYeTabWidget(Context context, AttributeSet attrs, int defStyle) {
...
//			}
	...
	public PeiYeTabWidget(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PeiYeTabWidget(Context context) {
		super(context);
		init(context);
	}
