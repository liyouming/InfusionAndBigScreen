...
public class XunShiTabWidget extends LinearLayout {

	private static final String TAG = "TabWidget";
	private int[] mDrawableIds = new int[] { R.drawable.tab_index_selector,
	...
	public XunShiTabWidget(Context context, AttributeSet attrs, int defStyle) {
...
//			}
	...
	public XunShiTabWidget(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public XunShiTabWidget(Context context) {
		super(context);
		init(context);
	}
