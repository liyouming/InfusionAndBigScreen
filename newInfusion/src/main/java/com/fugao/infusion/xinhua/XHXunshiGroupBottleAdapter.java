...
public class XHXunshiGroupBottleAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter{
    ...
    public XHXunshiGroupBottleAdapter(Context context, List<GroupBottleModel> items) {
        this.context = context;
        activity = (XHXunshiActivity)context;
        this.items = items;
    ...
    @Override public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        XHXunshiGroupBottleAdapter.ChildHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_patients_item_son, parent, false);
            holder = new XHXunshiGroupBottleAdapter.ChildHolder();
            ...
            holder = (XHXunshiGroupBottleAdapter.ChildHolder) convertView.getTag();
        }
        ...
        holder.btnMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {    //暂时注释
                activity.xhXunshiPeopleFragment.redirect2ExecuteBottleId(bottle.BottleId);
            }
        });
    ...
    @Override public View getGroupView(int groupPosition, boolean b, View convertView,
                                       ViewGroup parent) {
        XHXunshiGroupBottleAdapter.FatherHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_patients_item_father, parent, false);
            holder = new XHXunshiGroupBottleAdapter.FatherHolder();
            ...
            holder = (XHXunshiGroupBottleAdapter.FatherHolder) convertView.getTag();
        }
