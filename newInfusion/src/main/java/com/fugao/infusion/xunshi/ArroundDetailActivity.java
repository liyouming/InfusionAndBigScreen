...
public class ArroundDetailActivity extends BaseTempleActivity {
    ...
    public void initData() {
        ...
        infusionDetailDAO = new InfusionDetailDAO(DataBaseInfo.getInstance(ArroundDetailActivity.this));
...
//                intent.setClass(ArroundDetailActivity.this, HandlerActivity.class);
                intent.setClass(ArroundDetailActivity.this, NewHandlerActivity.class);
