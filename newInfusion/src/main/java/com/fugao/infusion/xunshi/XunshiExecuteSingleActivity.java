...
/**
 * @Description: TODO 穿刺和输液执行界面   单次执行（暂时没有用）
 */

public class XunshiExecuteSingleActivity extends BaseScanTestTempleActivity {
    ...
    public void setContentView() {
        setContentView(R.layout.activity_excute_single_xunshi);
    }


    @Override
    public void initView() {
        strings = ResourceUtils.getResouce4Arrays(XunshiExecuteSingleActivity.this, R.array.infusionstatus_handexecute_chuanci);
        infusionDetailDAO = new InfusionDetailDAO(DataBaseInfo.getInstance(XunshiExecuteSingleActivity.this));
//        initActionBar();
        InitCombox();
        //    initMargViews();
    ...
    private void InitCombox() {
        if (RoleCategory.CHUANCI.getKey() == LocalSetting.RoleIndex) {
            if (QueueStatusCategory.FINISHED.getKey() == LocalSetting.CurrentBottle.PeopleInfo.Status) {
                ...
                cboEditReason.getEditText().setText(inputReason[2]);
    ...
    private void cancelFinishInfusion() {
        ...
        RestClient.put(context, ChuanCiApi.url_getCancelInfusion(1), json, new BaseAsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, String s) {
                ...
                XunshiExecuteSingleActivity.this.finish();
            }
                            ...
                            RestClient.get(url, new BaseAsyncHttpResponseHandler() {
                                ...
                                public void onSuccess(int i, String s) {
                                    if(Integer.parseInt(s) ==1){
                                        UIHepler.showToast(XunshiExecuteSingleActivity.this,"结束正在输液成功");
                                    }else {
                                        UIHepler.showToast(XunshiExecuteSingleActivity.this,"结束正在输液失败");
                                    }
                                }
...
//                            needEndOther = false;
                                ...
                                case 1:
                                    ...
                                    if (!cbBottle.isChecked()) {
                                        ...
                                        if (inputText.equals(currentBottle.PeopleInfo.QueueNo)
                                            ...
                                            WarningToast.newInstance(XunshiExecuteSingleActivity.this, "核对病人信息成功");
    ...
    protected void showPopMenu() {
        if (popMenu == null) {
            popMenu = new PopMenu(XunshiExecuteSingleActivity.this);
