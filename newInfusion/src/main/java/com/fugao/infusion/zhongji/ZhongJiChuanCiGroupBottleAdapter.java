...
public class ZhongJiChuanCiGroupBottleAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
  ...
  public ZhongJiChuanCiGroupBottleAdapter(Context context, List<GroupBottleModel> items) {
      this.context = context;
      activity = (ZhongjiXunshiActivity)context;
      this.items = items;
  ...
  @Override public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild,
    ...
    holder.btnMore.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {    //暂时注释
            activity.zhongJiChuanCiPeopleFragment.redirect2ExecuteSingleByClick(bottle);
        }
    });
...
//      holder.patient_content_gms.setText("aaaaaaaaaaaaaaaaaaaaaa");
