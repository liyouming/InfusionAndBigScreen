...
public class ZhongJiNewXunshiExecuteSingleActivity extends BaseScanTestTempleActivity {
    ...
    public void initView() {
        strings = ResourceUtils.getResouce4Arrays(ZhongJiNewXunshiExecuteSingleActivity.this, R.array.infusionstatus_handexecute_chuanci);
        infusionDetailDAO = new InfusionDetailDAO(DataBaseInfo.getInstance(ZhongJiNewXunshiExecuteSingleActivity.this));
        //        initActionBar();
        InitCombox();
        initCheckBox();
        //    initMargViews();
    ...
    public void initData() {
        loadingDialog = new ProgressDialog(ZhongJiNewXunshiExecuteSingleActivity.this);
        beepManager = new BeepManager(ZhongJiNewXunshiExecuteSingleActivity.this);
    ...
    private void cancel() {
        ...
        RestClient.get(ChuanCiApi.url_getPostCall(currentBottle.PeopleInfo.DepartmentId, currentBottle.InfusionId, punctureDeptId), new BaseAsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, String s) {
                ...
                ZhongJiNewXunshiExecuteSingleActivity.this.finish();
            }
...
//    }
    ...
    protected void showPopMenu() {
        if (popMenu == null) {
            popMenu = new PopMenu(ZhongJiNewXunshiExecuteSingleActivity.this);
...
//                                                            patrolDetailBean.Expand = inputText;
                                            ...
                                            if (currentBottle.BottleStatus != BottleStatusCategory.HADINFUSE.getKey())
                                                WarningToast.newInstance(ZhongJiNewXunshiExecuteSingleActivity.this, "核对病人信息成功");

                                        } else {
                                            cbBand.setChecked(false);
                                            InfusionUIHelper.showWarningDialogByCustom(context, "病人ID录入错误!");
                                            InfoUtils.warningComfirmError(ZhongJiNewXunshiExecuteSingleActivity.this,beepManager);
    ...
    protected void receiverPatientId(String patientId) {
        ...
        if (currentBottle.PeopleInfo.PatId.equals(patientId)) {
            ...
            InfoUtils.recordConfirmError(ZhongJiNewXunshiExecuteSingleActivity.this,infusionEventModels);
