...
public class ZhongJiXunshiGroupBottleAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
  ...
  public ZhongJiXunshiGroupBottleAdapter(Context context, List<GroupBottleModel> items) {
            ...
            RestClient.get(url, new BaseAsyncHttpResponseHandler() {
                ...
                public void onSuccess(int i, String s) {
                    ...
                    if (infusioningModel.bottle != null) {
                        ...
                        activity.zhongjiXunshiPeopleFragment.redirect2ExecuteSingleByClick(bottle);
