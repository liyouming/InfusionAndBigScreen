...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            LinearLayout addLayout = ((LinearLayout) layout
                    .findViewById(R.id.add_layout));
            TextView messageText = ((TextView) layout
                    .findViewById(R.id.message));
            dialog.addContentView(layout, new LayoutParams(
                    LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
            // set the dialog title
            if (StringUtils.StringIsEmpty(title)) {
                ((LinearLayout) layout.findViewById(R.id.dialog_title_layout))
                        .setVisibility(View.GONE);
                ((View) layout.findViewById(R.id.dialog_line))
                        .setVisibility(View.GONE);
            ...
            if (message != null) {
                ...
                addLayout.addView(contentView, new LayoutParams(
