...
import com.fugao.newbigscreen.model.PatrolModel;
...
//    }
     ...
     * 输液和等待队列
     */
    public static InfusionCallAndWaitModel string2InfusionCallAndWaitModel(String s){
        InfusionCallAndWaitModel infusionCallAndWaitModel=new InfusionCallAndWaitModel();
        try {
            infusionCallAndWaitModel=objectMapper.readValue(s,InfusionCallAndWaitModel.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return infusionCallAndWaitModel;
    }
    public static ArrayList<InfusionAreaBean> string2InfusionAreaBeans(String string) {
        ArrayList<InfusionAreaBean> infusionAreaBeans = new ArrayList<InfusionAreaBean>();
     ...
     * 得到呼叫队列信息
     */
    public static InfusionCallQueue string2InfusionCallQueue(String string){
        InfusionCallQueue infusionCallQueue=new InfusionCallQueue();
        try {
            infusionCallQueue=objectMapper.readValue(string,InfusionCallQueue.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
